# Junie Guidelines (Saturday Framework)

Project guidelines for the JetBrains Junie agent. Junie reads this file before falling back to
AGENTS.md at the repository root — same content is kept in sync by the framework installer.
